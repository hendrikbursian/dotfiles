...
_G.packer_plugins = {
  ...
  ["dap-buddy.nvim"] = {
    loaded = true,
    path = "/home/hendrik/.config/local/share/nvim/site/pack/packer/start/dap-buddy.nvim",
  ...
  ["lsp_extensions.nvim"] = {
    loaded = true,
    path = "/home/hendrik/.config/local/share/nvim/site/pack/packer/start/lsp_extensions.nvim",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/hendrik/.config/local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["vim-commentary"] = {
    loaded = true,
    path = "/home/hendrik/.config/local/share/nvim/site/pack/packer/start/vim-commentary",
  ...
  ["vim-surround"] = {
    loaded = true,
    path = "/home/hendrik/.config/local/share/nvim/site/pack/packer/start/vim-surround",
    url = "https://github.com/tpope/vim-surround"
  },
  ["vim-test"] = {
    loaded = true,
    path = "/home/hendrik/.config/local/share/nvim/site/pack/packer/start/vim-test",
